...
import com.oryxos.core.mcp.McpCatalogEntry;
import com.oryxos.core.mcp.McpServerAdmin;
import com.oryxos.core.mcp.McpServerConfig;
import com.oryxos.web.dto.ApiResponse;
import com.oryxos.web.dto.EnableMcpCatalogRequest;
import com.oryxos.web.dto.McpCatalogView;
import com.oryxos.web.dto.McpServerStatusView;
import com.oryxos.web.dto.McpServerView;
...
/**
 * MCP server 管理台 CRUD:薄转发给 {@link McpServerAdmin}(依赖倒置——web 只认这个 core 契约,具体实现在 tool,同 {@code
 * SandboxWhitelistController} 之于 {@code SandboxWhitelistPort} 的既有分层方式)。
 *
