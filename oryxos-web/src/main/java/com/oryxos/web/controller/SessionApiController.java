...
public class SessionApiController {
    ...
    public ApiResponse<Map<String, String>> sendMessage(@PathVariable String id, @RequestBody Map<String, String> body) {
    ...
    public ApiResponse<List<Map<String, String>>> history(@PathVariable String id) {
        ...
        List<Map<String, String>> messages = session.getMessages().stream()
