...
/**
 * oryxos init — 初始化工作区。
 * 创建 .oryxos/ 目录及完整结构(agents/ skills/ output/ memory/ sessions/ logs/
...
public class InitCommand implements Runnable {
    ...
    @Option(names = {"-w", "--workspace"}, defaultValue = ".oryxos", description = "工作区路径")
    String workspace;
    ...
    public void run() {
        try {
            ...
            createIfAbsent(root.resolve("memory/MEMORY.md"),
                    "# Memory\n\n## 核心记忆\n\n## 归档记忆\n");
