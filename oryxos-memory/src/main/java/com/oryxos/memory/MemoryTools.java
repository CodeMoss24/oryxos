...
/**
 * 把长期记忆暴露给 Agent 调用,包含 save_memory 和 recall_memory 两个内置 Tool,
 * 跟其他内置 Tool 一视同仁注册到 ToolRegistry。
 */
@Component
public class MemoryTools {
    ...
    public class SaveMemoryTool implements OryxTool {
        ...
        @Override public String getDescription() { return "把内容追加到长期记忆(MEMORY.md)"; }
    ...
    public class RecallMemoryTool implements OryxTool {
        ...
        @Override public String getDescription() { return "按关键词检索长期记忆"; }
        @Override public String getInputSchema() {
